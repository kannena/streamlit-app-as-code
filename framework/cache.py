...
class CacheManager:
    ...
    def _make_key(self, cache_type: str, **kwargs) -> Optional[str]:
        if not self.enabled:
            return None
    ...
    @staticmethod
    def _has_expired(cache_entry: Dict) -> bool:
    ...
    def get(self, cache_type: str, **kwargs) -> Optional[Any]:
        ...
        if not self.enabled:
            return None
        cache_key = self._make_key(cache_type, **kwargs)
        if not cache_key:
            return None
