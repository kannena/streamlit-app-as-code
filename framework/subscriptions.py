...
class ScheduleManager:
    ...
    def _summarize_schedule(self, frequency, schedule_time=None,
...
def create_manager(session, config, db_name, environment, **kwargs):
    """Factory function for creating a ScheduleManager instance."""
    return ScheduleManager(session, config, db_name, environment, **kwargs)
