...
def resolve_access_level(session, role_table: str, username: str) -> str:
    """
...
def fetch_granted_roles(session, username: str) -> list:
    """
...
def has_admin_access(session, role_table: str, username: str) -> bool:
    """Check whether the user has REPORT_ADMIN or higher privileges."""
    level = resolve_access_level(session, role_table, username)
